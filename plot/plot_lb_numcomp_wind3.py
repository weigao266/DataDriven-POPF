...
df = pd.read_csv('./wind_station_datasets/wind_station_3/98359-2012.csv', skiprows=3)
...
scipy.io.savemat('./data/data_lb_numcomp_wind3.mat', {'lb_numcomp_wind3': All_LB})

# plot
plt.switch_backend('agg')
plt.plot(range(Iter_gap, Max_iter, Iter_gap), All_LB, marker='o')
plt.savefig('./figures/fig_lb_numcomp_wind3.eps', dpi=1000)
# plt.show()
